...
In Vivado behavioral simulation, hashing an empty string took:
...
Vivado simulation can compute SHA hashes faster than a desktop CPU, and 100 MHz is only illustrative until I can find the real frequency with timing analysis. Also, the accelerator gets an already padded block, but the software

library does its own padding. See [methodology and
